export default function OwnerPage() {
    return (
        <div className="flex flex-col h-screen bg-gray-300 items-center">
            <h1 className="text-2xl font-bold my-3">30_Soravit</h1>
            <div className="w-[400px] h-[400px] border border-black rounded-full overflow-hidden">
                <img src="src/assets/Batman-slapping-Robin-Meme-Blank.avif" alt="Soravit" className="object-cover w-full h-full" />
            </div>
